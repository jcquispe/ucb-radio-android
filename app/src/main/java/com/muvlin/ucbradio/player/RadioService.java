...
public class RadioService extends Service implements Player.EventListener, AudioManager.OnAudioFocusChangeListener {
    public static final String ACTION_PLAY = "com.muvlin.ucbradio.player.ACTION_PLAY";
    public static final String ACTION_PAUSE = "com.muvlin.ucbradio.player.ACTION_PAUSE";
    public static final String ACTION_STOP = "com.muvlin.ucbradio.player.ACTION_STOP";
